;( function( $, window, document, undefined ) {
    document.addEventListener("DOMContentLoaded", function () {
        // Add an event listener to the role toggle radio buttons
        var roleToggle = document.querySelectorAll('.role-toggle');
        
        roleToggle.forEach(function (toggle) {
          toggle.addEventListener('change', function () {
            // Check if the "Other Option" radio button is selected
            if (document.getElementById('user-toggle').checked) {
